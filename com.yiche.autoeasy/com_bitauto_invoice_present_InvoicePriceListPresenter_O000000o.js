...
//com.bitauto.invoice.present.InvoicePriceListPresenter:O000000o
...
Java.perform(function() {
    ...
    var com_bitauto_invoice_present_InvoicePriceListPresenter_clz_method_O000000o_3654 = com_bitauto_invoice_present_InvoicePriceListPresenter_clz.O000000o.overload('com.bitauto.invoice.bean.InvoicePriceListResponseBean', 'java.lang.String', 'java.lang.String');
    com_bitauto_invoice_present_InvoicePriceListPresenter_clz_method_O000000o_3654.implementation = function(v0, v1, v2) {
        log("参数1:" + v0);
        log("参数2:" + v1);
        log("参数3:" + v2);
        ...
        com_bitauto_invoice_present_InvoicePriceListPresenter_clz_method_O000000o_3654.call(this, v0, v1, v2);
        printBeat(beat);
    };
