...
//com.bitauto.libcommon.tools.Encrypt:decrypt
...
//com.bitauto.libcommon.tools.Encrypt:decrypt
Java.perform(function() {
    var com_bitauto_libcommon_tools_Encrypt_clz = Java.use('com.bitauto.libcommon.tools.Encrypt');
    var com_bitauto_libcommon_tools_Encrypt_clz_method_decrypt_5461 = com_bitauto_libcommon_tools_Encrypt_clz.decrypt.overload('java.lang.String', 'java.lang.String');
    com_bitauto_libcommon_tools_Encrypt_clz_method_decrypt_5461.implementation = function(v0, v1) {
        log("参数1:"+v0 + " 参数2:"+v1);
        var executor = 'Class';
        var beatText = 'public static native java.lang.String com.bitauto.libcommon.tools.Encrypt.decrypt(java.lang.String,java.lang.String)';
        var beat = newMethodBeat(beatText, executor);
        var ret = com_bitauto_libcommon_tools_Encrypt_clz_method_decrypt_5461.call(com_bitauto_libcommon_tools_Encrypt_clz, v0, v1);
        printBeat(beat);
        log("解密结果:"+ret);
        return ret;
    };
