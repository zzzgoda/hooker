...
//com.bitauto.invoice.bean.InvoicePriceListResponseBean:_
...
function getClassName(obj) {
    var javaObjectClass = Java.use("java.lang.Object");
    return Java.cast(obj, javaObjectClass).getClass().getName();
}
...
function storeObjectAndLog(javaObject) {
    ...
    var objectId = ObjectsStore.storeObject.overload('java.lang.Object').call(ObjectsStore, javaObject);
...
//com.bitauto.invoice.bean.InvoicePriceListResponseBean:_
Java.perform(function() {
    var com_bitauto_invoice_bean_InvoicePriceListResponseBean_clz = Java.use('com.bitauto.invoice.bean.InvoicePriceListResponseBean');
    var com_bitauto_invoice_bean_InvoicePriceListResponseBean_clz_init_4124 = com_bitauto_invoice_bean_InvoicePriceListResponseBean_clz.$init.overload();
    com_bitauto_invoice_bean_InvoicePriceListResponseBean_clz_init_4124.implementation = function() {
        var executor = this.hashCode();
        var beatText = 'public com.bitauto.invoice.bean.InvoicePriceListResponseBean()';
        var beat = newMethodBeat(beatText, executor);
        var returnObj = com_bitauto_invoice_bean_InvoicePriceListResponseBean_clz_init_4124.call(this);
        printBeat(beat);
