...
//com.bitauto.invoice.view.InvoicePriceListActivity:onRequestSuccess
...
//com.bitauto.invoice.view.InvoicePriceListActivity:onRequestSuccess
Java.perform(function() {
    var com_bitauto_invoice_view_InvoicePriceListActivity_clz = Java.use('com.bitauto.invoice.view.InvoicePriceListActivity');
    var com_bitauto_invoice_view_InvoicePriceListActivity_clz_method_onRequestSuccess_4796 = com_bitauto_invoice_view_InvoicePriceListActivity_clz.onRequestSuccess.overload('java.lang.String', 'java.lang.Object');
    com_bitauto_invoice_view_InvoicePriceListActivity_clz_method_onRequestSuccess_4796.implementation = function(v0, v1) {
        log(v0 + ">>>" + getClassName(v1));
        if (v0 == "S_TAG_MERAGE_API") {
            log(fastTojson(v1));
        }
        var executor = this.hashCode();
        var beatText = 'public void com.bitauto.invoice.view.InvoicePriceListActivity.onRequestSuccess(java.lang.String,java.lang.Object)';
        var beat = newMethodBeat(beatText, executor);
        com_bitauto_invoice_view_InvoicePriceListActivity_clz_method_onRequestSuccess_4796.call(this, v0, v1);
        printBeat(beat);
    };
});